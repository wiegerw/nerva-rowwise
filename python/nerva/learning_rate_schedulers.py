...
class LearningRateScheduler(nervalibrowwise.learning_rate_scheduler):
    pass
...
class StepBasedScheduler(nervalibrowwise.step_based_scheduler):
...
class MultiStepLRScheduler(nervalibrowwise.multi_step_lr_scheduler):
...
class ExponentialScheduler(nervalibrowwise.exponential_scheduler):
