...
- `ONEAPI_ROOT`: Path to the OneAPI installation directory.
- `MKL_DIR`: Path to the MKL installation directory.
- `MKL_NUM_THREADS`: Controls the number of threads used at runtime by the MKL library.
- `OMP_NUM_THREADS`: Controls the number of threads used at runtime by the OMP library.
- `NERVA_ENABLE_SYCL`: Set this variable to enable the SYCL computation mode.
- `NERVA_USE_DOUBLE`: Set this variable to use double instead of single precision in the computations.
...
include::shared.adoc[tags=mlptool-options]

include::shared.adoc[tags=general-options]

* `--verbose`, `-v`
Show verbose output.

include::shared.adoc[tags=random-generator-options]

include::shared.adoc[tags=layer-configuration-options]

include::shared.adoc[tags=training-configuration-options]

include::shared.adoc[tags=dataset-options]
...
include::shared.adoc[tags=pruning-options]
include::shared.adoc[tags=computation-options]
include::shared.adoc[tags=miscellaneous-options]
...
include::shared.adoc[tags=event-functions]
...
include::shared.adoc[tags=event-actions]
