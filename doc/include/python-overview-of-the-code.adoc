...
[source,cpp]
----
include::{root}/python/tests/multilayer_perceptron_test.py[tag=construct1]
----
...
[source,cpp]
----
include::{root}/python/tests/multilayer_perceptron_test.py[tag=construct2]
----
...
[source,python]
----
include::{root}/python/nerva/layers.py[tag=dense_constructor]
----
This only sets a number of attributes of the layer. Before using the layer the `compile` function must be called:
[.small-code]
[source,python]
----
include::{root}/python/nerva/layers.py[tag=dense_compile]
----
...
[source,python]
----
include::{root}/python/nerva/layers.py[tag=batchnormalization_constructor]
----
...
[source,python]
----
include::{root}/python/tests/multilayer_perceptron_test.py[tag=layer-access]
----
...
[source,python]
----
include::{root}/python/tools/mlp.py[tag=event]
----
