...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/settings.h[tag=doc]
----
...
[source,cpp]
----
include::{root}/tests/multilayer_perceptron_test.cpp[tag=doc]
----
...
[source,cpp]
----
include::{root}/tests/gradient_test.cpp[tag=construct_mlp]
----
...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/layers.h[tag=layer]
----
...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/loss_functions.h[tag=doc]
----
...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/activation_functions.h[tag=doc]
----
...
[source,cpp]
----
include::{root}/tools/mlp.cpp[tag=event]
----
...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/batch_normalization_layers.h[tag=timer]
----
