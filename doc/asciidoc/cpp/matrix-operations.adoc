...
[source,cpp]
----
include::{root}/include/nerva/neural_networks/layers.h[tag=matrix_operations]
----
See the paper https://arxiv.org/abs/2511.11918[Batch Matrix-form Equations and Implementation of Multilayer Perceptrons] for an overview of how these matrix operations are used.
